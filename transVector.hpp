...
private:
	...
	void insertPages(std::map<size_t, Page<VAL, SGMT_SIZE> *, ORDER, MemAllocator<std::pair<size_t, Page<VAL, SGMT_SIZE> *>>> *pages, bool helping = false, size_t startPage = SIZE_MAX);
