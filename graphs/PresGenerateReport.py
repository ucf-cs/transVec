...
df1 = pd.read_csv('Intelfinal_report1209112134.txt', sep='\t', names=init_cols, skiprows=1)
df2 = pd.read_csv('AMDfinal_report1206201100.txt',   sep='\t', names=init_cols, skiprows=1)
df3 = pd.read_csv('ARMfinal_report1206201101.txt',   sep='\t', names=init_cols, skiprows=1)
df4 = pd.read_csv('NUMAfinal_report1206201059.txt',   sep='\t', names=init_cols, skiprows=1)
